...
PANEL_I18N = {
    'fr': {
        ...
        'xplane_detecting': 'Détection en cours...',
        'xplane_running': '✅  X-Plane en cours d\'exécution',
        'xplane_not_detected': '⚠️  X-Plane non détecté',
        'xplane_not_found': '❌  X-Plane introuvable sur cette machine',
    ...
    'en': {
        ...
        'server_port_mode': 'Port: {port}  |  Mode: {mode}',
        'xplane_title': '🎮  X-Plane',
        'xplane_detecting': 'Detecting...',
        'xplane_running': '✅  X-Plane is running',
        'xplane_not_detected': '⚠️  X-Plane not detected',
...
class AutoYawPanel:
    ...
    def _check_xplane(self):
        ...
        if self.xplane_running:
            ...
            if self.xplane_path:
                self.xplane_status_label.config(text=self.t['xplane_not_detected'], fg=self.WARNING)
