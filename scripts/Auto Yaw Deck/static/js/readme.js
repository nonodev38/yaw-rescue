...
function openReadme() {
    ...
    openModal(
        document.getElementById('readme-modal'),
        document.getElementById('readme-title'),
        document.getElementById('readme-body'),
        data
    );
}
...
function _initReadmeModal() {
    const modal = document.getElementById('readme-modal');
    if (modal) initModal(modal);
}
if (document.readyState === 'loading') {
    document.addEventListener('DOMContentLoaded', _initReadmeModal);
} else {
    _initReadmeModal();
}
