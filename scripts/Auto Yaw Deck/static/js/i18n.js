...
const I18N = {
    fr: {
        ...
        'status.connected': '🟢 Connecté — X-Plane en cours',
        'status.disconnected': '🔍 En attente de connexion...',
        'status.loading': '⏳ CHARGEMENT',
        'status.loading_xplane': '⏳ X-Plane en chargement...',
        'status.waiting': 'EN ATTENTE',
        'status.server_only': '🟡 Serveur actif — X-Plane pas lancé',
        // Connection page
        ...
        'connect.support': '❤️ Soutenir Yaw Rescue',
        ...
        'connect.launch_xplane': '▶ Lancer X-Plane depuis le PC',
        'connect.launching': '⏳ X-Plane en cours de démarrage...',
        'connect.launch_error': '❌ Erreur lors du lancement',
        // Tabs
        'tab.config': '⚙️ Config',
        ...
        // Telemetry
        'telemetry.instruments': 'Instruments de vol',
        ...
        'telemetry.yaw_rate': 'Taux de lacet',
        'telemetry.flap_vfe': 'VFE',
        'telemetry.aircraft': 'Avion',
        'telemetry.no_aircraft': 'Aucun avion détecté',
        // Diagrams
        'diagram.flaps': 'Volets',
        'diagram.flaps_sub': 'rentrés → sortis',
        'diagram.pitch': 'Profondeur',
        'diagram.pitch_sub': 'nez haut / bas',
        'diagram.roll': 'Ailerons',
        'diagram.roll_sub': 'inclinaison',
        'diagram.yaw': 'Direction',
        'diagram.yaw_sub': 'nez gauche / droite',
        // Actions
        'actions.calibrate': 'Calibrer joystick',
        'actions.reset_defaults': 'Réinitialiser par défaut',
        'actions.save_profile': 'Sauvegarder profil',
        'actions.load_profile': 'Charger profil',
    },
    en: {
        // Status
        'status.offline': 'OFFLINE',
        'status.live': 'LIVE',
        'status.connected': '🟢 Connected — X-Plane running',
        'status.disconnected': '🔍 Waiting for connection...',
        'status.loading': '⏳ LOADING',
        'status.loading_xplane': '⏳ X-Plane loading...',
        'status.waiting': 'WAITING',
        'status.server_only': '🟡 Server active — X-Plane not running',
        // Connection page
        ...
        'connect.support': '❤️ Support Yaw Rescue',
        ...
        'connect.launch_xplane': '▶ Launch X-Plane from PC',
        'connect.launching': '⏳ Starting X-Plane...',
        'connect.launch_error': '❌ Failed to launch X-Plane',
        // Tabs
        'tab.config': '⚙️ Config',
        ...
        // Telemetry
        'telemetry.instruments': 'Flight Instruments',
        ...
        'telemetry.yaw_rate': 'Yaw rate',
        'telemetry.flap_vfe': 'VFE',
        'telemetry.aircraft': 'Aircraft',
        'telemetry.no_aircraft': 'No aircraft detected',
        // Diagrams
        'diagram.flaps': 'Flaps',
        'diagram.flaps_sub': 'retracted → extended',
        'diagram.pitch': 'Pitch',
        'diagram.pitch_sub': 'nose up / down',
        'diagram.roll': 'Roll',
        'diagram.roll_sub': 'bank angle',
        'diagram.yaw': 'Yaw',
        'diagram.yaw_sub': 'nose left / right',
        // Actions
        'actions.calibrate': 'Calibrate joystick',
        'actions.reset_defaults': 'Reset to defaults',
        'actions.save_profile': 'Save profile',
        'actions.load_profile': 'Load profile',
    }
};
...
function applyLanguage(lang) {
    ...
    if (typeof currentState !== 'undefined' && currentState.xplane_active !== undefined) {
        setConnected(isConnected, currentState.xplane_active === 'true', currentState.xplane_state || 'off');
    } else {
