...
-- FIX: Use new dataref name (sim/flightmodel/position/magpsi was replaced)
...
local dr_flap_ratio = dataref_table("sim/cockpit2/controls/flap_handle_request_ratio")
